...
class MachineLearning extends StatefulWidget {
  MachineLearning({Key? key}) : super(key: key);

  @override
  State<MachineLearning> createState() => _MachineLearning();
}

class _MachineLearning extends State<MachineLearning> {
  List videoInfo4 = [
    {
      "title": "TUTORIAL 11",
            ...
            children: [
              ...
              FlatButton(
                  onPressed: () async {
                    ...
                    if (index >= 0 && videoInfo4.length >= 0) {
  ...
  _initializeVideo(int index) async {
    final controller =
        VideoPlayerController.network(videoInfo4[index]["videoUrl"]);
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage(videoInfo4[index]['thumbnail']),
                        fit: BoxFit.cover)),
              ),
              SizedBox(
                width: 10,
