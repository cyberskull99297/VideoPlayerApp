...
class CloudComp extends StatefulWidget {
  CloudComp({Key? key}) : super(key: key);

  @override
  State<CloudComp> createState() => _CloudComp();
}

class _CloudComp extends State<CloudComp> {
  List videoInfo5 = [
    {
      "title": "TUTORIAL00 44",
            ...
            children: [
              ...
              FlatButton(
                  onPressed: () async {
                    ...
                    if (index >= 0 && videoInfo5.length >= 0) {
  ...
  _initializeVideo(int index) async {
    final controller =
        VideoPlayerController.network(videoInfo5[index]["videoUrl"]);
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage(videoInfo5[index]['thumbnail']),
                        fit: BoxFit.cover)),
              ),
              SizedBox(
                width: 10,
