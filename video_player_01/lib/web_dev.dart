...
class WebDev extends StatefulWidget {
  WebDev({Key? key}) : super(key: key);

  @override
  State<WebDev> createState() => _WebDev();
}

class _WebDev extends State<WebDev> {
  List videoInfo2 = [
    {
      "title": "TUTORIAL 02",
            ...
            children: [
              ...
              FlatButton(
                  onPressed: () async {
                    ...
                    if (index >= 0 && videoInfo2.length >= 0) {
  ...
  _initializeVideo(int index) async {
    final controller =
        VideoPlayerController.network(videoInfo2[index]["videoUrl"]);
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage(videoInfo2[index]['thumbnail']),
                        fit: BoxFit.cover)),
              ),
              SizedBox(
                width: 10,
