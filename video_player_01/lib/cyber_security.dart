...
class CyberSecurity extends StatefulWidget {
  CyberSecurity({Key? key}) : super(key: key);

  @override
  State<CyberSecurity> createState() => _CyberSecurity();
}

class _CyberSecurity extends State<CyberSecurity> {
  List videoInfo1 = [
    {
      "title": "Bee on flower",
      "time": "120 seconds",
            ...
            children: [
              ...
              FlatButton(
                  onPressed: () async {
                    ...
                    if (index >= 0 && videoInfo1.length >= 0) {
  ...
  _initializeVideo(int index) async {
    final controller =
        VideoPlayerController.network(videoInfo1[index]["videoUrl"]);
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage(videoInfo1[index]['thumbnail']),
                        fit: BoxFit.cover)),
              ),
              SizedBox(
                width: 10,
